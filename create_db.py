...
cur.execute("DELETE FROM klienti")
cur.execute("DELETE FROM stroje")
...
cur.executemany("INSERT INTO klienti VALUES (NULL, ?, ?, ?, ?, ?)", klienti)
...
cur.executemany("INSERT INTO stroje VALUES (?, ?, ?)", stroje)

conn.commit()
conn.close()
print("✅ Databáze vytvořena a naplněna.")
